...
import '../settings/receipts_slips_screen.dart';
        ...
        children: [
          ...
          _buildCard(
            children: [
              ...
              const SizedBox(height: 10),
              // The toggles above set what the shipped slips show. This is
              // where the slip itself is designed, and where each order type
              // is pointed at the one it should print.
              ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                  backgroundColor: context.canvasColor,
                  foregroundColor: context.textPrimary,
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const ReceiptsSlipsScreen()),
                  );
                },
